...
public class R_HorizontalListViewAdapter extends RecyclerView.Adapter<R_HorizontalListViewAdapter.Holder> {

    ServerCommand serverCommand;
    ArrayList<GetI30List> getI30Lists;
    ArrayList<GetI30ContList> getI30ContLists;
    ArrayList<R_HorizontalListViewItem> items;

    public R_HorizontalListViewAdapter(ServerCommand serverCommand, ArrayList<GetI30List> getI30Lists, ArrayList<GetI30ContList> getI30ContLists, ArrayList<R_HorizontalListViewItem> items) {
    ...
    public Holder onCreateViewHolder(@NonNull final ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.r_horizontal_listview_item, viewGroup, false);
